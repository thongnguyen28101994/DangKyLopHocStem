 ...
 const submitData =  (e,value) => {
  ...
  useEffect(()=>{
    if(billList.length>0)
    {
       ...
       const newSortedData =  newData.map((z)=>({STT:z["STT"],QUAN_HUYEN:z["QUAN_HUYEN"],TEN_TRUONG:z["TEN_TRUONG"],TEN_DON_VI:z["Name"],MA_SO_THUE:z["TaxCode"],Email:z["Email"],DienThoai:z["Phone"],HINH_THUC_CHON:z["IsCreateBillFirst"],Yeu_Cau_Xuat_Hoa_Don:z["IsMergeBill"],SO_LUONG_HOA_DON:z["QuantityRegister"],TRUONG_GHI_CHU:z["SchoolNote"]}))
